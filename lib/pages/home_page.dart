...
import 'package:firebaseconn2g15/pages/maps/maps1_page.dart';
import 'package:firebaseconn2g15/pages/maps/maps2_page.dart';
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Maps1Page()),
                );
              },
